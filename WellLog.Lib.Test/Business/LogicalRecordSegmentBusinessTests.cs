...
namespace WellLog.Lib.Test.Business
{
    ...
    public class LogicalRecordSegmentBusinessTests
    {
        ...
        [Test]
        public void LogicalRecordSegmentBusiness_GetTrailerSize_Pass_NullHeader()
        {
            Assert.AreEqual(0, _logicalRecordSegmentBusiness.GetTrailerSize(null, new LogicalRecordSegmentTrailer()));
        }

        [Test]
        public void LogicalRecordSegmentBusiness_GetTrailerSize_Pass_NullTrailer()
        {
            Assert.AreEqual(0, _logicalRecordSegmentBusiness.GetTrailerSize(new LogicalRecordSegmentHeader(), null));
        }

        [Test]
        public void LogicalRecordSegmentBusiness_GetTrailerSize_Pass_TrailingLength()
        {
            var header = new LogicalRecordSegmentHeader
            {
                LogicalRecordSegmentAttributes = 0b_0000_0010
            };
            Assert.AreEqual(2, _logicalRecordSegmentBusiness.GetTrailerSize(header, new LogicalRecordSegmentTrailer()));
        }

        [Test]
        public void LogicalRecordSegmentBusiness_GetTrailerSize_Pass_Checksum()
        {
            var header = new LogicalRecordSegmentHeader
            {
                LogicalRecordSegmentAttributes = 0b_0000_0100
            };
            Assert.AreEqual(2, _logicalRecordSegmentBusiness.GetTrailerSize(header, new LogicalRecordSegmentTrailer()));
        }

        [Test]
        public void LogicalRecordSegmentBusiness_GetTrailerSize_Pass_Padding()
        {
            var header = new LogicalRecordSegmentHeader
            {
            ...
            Assert.AreEqual(2, _logicalRecordSegmentBusiness.GetTrailerSize(header, trailer));
        }

        [Test]
        public void LogicalRecordSegmentBusiness_GetTrailerSize_Pass()
        {
            var header = new LogicalRecordSegmentHeader
            {
            ...
            Assert.AreEqual(7, _logicalRecordSegmentBusiness.GetTrailerSize(header, trailer));
        }
